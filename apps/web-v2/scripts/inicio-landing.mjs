...
const solutions = [
  ...
  { id: 'ecommerce', need: 'Quiero vender\npor internet.', name: 'Cóndor Ecommerce', text: 'Una tienda para que tus productos encuentren a sus próximos clientes. Si quieres acompañarla con publicidad, la gestión de paid media está cubierta por la comisión del 6,7% por venta facturada.', includes: 'Tienda online · pagos · publicidad opcional', cta: 'Conocer Ecommerce' },
