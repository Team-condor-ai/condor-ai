...
function medir(fila) {
  ...
  /* BUG corregido 22-ago-2026 (mismo que en meta-analyzer.mjs): las dos
     métricas se solapan y sumarlas inflaba las conversaciones ~2,1x. Se usa la
     primera, que es la que muestra el administrador de anuncios; la segunda es
     más ancha y queda solo de respaldo para campañas que no reporten la
     primera. Nunca se suman ni se toma la mayor. */
